      ...
      <div className={Styles.card}>
        ...
        <div className={Styles.textcard}>
          ...
          <div className={Styles.text}>
            ...
            Bootcamp. I&apos;m from Medellin - Colombia achieved my bachelor and
            a graduate degree in the National University of Colombia; my main
            goal in the Bootcamp will be to boost my coding skills then find my
            path in the developing world, finally, my main hobbies are watching
            sci-fi series and reading books, I like pasta, pizza, and driving
            bikes.
          </div>
        </div>
      </div>
      <div className={Styles.card}>
        ...
        <div className={Styles.textcard}>
          ...
          <div className={Styles.text}>
            ...
            adapters like Axios. We have learned under the SCRUM methodology and
            published our code into our repositories in the GitHub servers. In
            the following weeks, We&apos;ll be learning Backend topics and new
            technologies such as MongoDB, Express, and Nodejs.
          </div>
        </div>
      </div>
    </div>
